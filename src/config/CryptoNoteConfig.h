...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t MONEY_SUPPLY = UINT64_C(100'000'000);
        ...
        const char GENESIS_COINBASE_TX_HEX[] = "";
    ...
    const char CRYPTONOTE_NAME[] = "BlockchainGoldCoin";
    ...
    const int P2P_DEFAULT_PORT = 1920;

    const int RPC_DEFAULT_PORT = 1085;

    const int SERVICE_DEFAULT_PORT = 2001;
    ...
    const char LATEST_VERSION_URL[] = "https://blockchaingoldcoin.com";

    const std::string LICENSE_URL = "https://github.com/turtlecoin/turtlecoin/blob/master/LICENSE";

    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {0xb7, 0x0d, 0x4e, 0x6a, 0xcf, 0x52, 0x57, 0x41, 0x65, 0xf8, 0x94, 0xa4, 0xb6, 0xc1, 0x43, 0xe9}};

    const char *const SEED_NODES[] = {
        "34.134.42.184:1920", // cision
        "35.238.157.101:1920", // iburnmycd
    };
} // namespace CryptoNote
